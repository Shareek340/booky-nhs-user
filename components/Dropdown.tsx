import { DropdownMenuContent,DropdownMenu, DropdownMenuGroup, DropdownMenuItem,DropdownMenuLabel,DropdownMenuSeparator,DropdownMenuShortcut,DropdownMenuTrigger} from '@/components/ui/dropdown-menu';
        ...
        <DropdownMenuContent className='w-72 mt-4  p-4 flex flex-col gap-2' align='start'>
            ...
            <LogoutLink>
                <DropdownMenuItem>Log Out 
                    <DropdownMenuShortcut className='text-lg text-accent'><FaSignOutAlt/></DropdownMenuShortcut>
                </DropdownMenuItem>
            </LogoutLink>
        </DropdownMenuContent>
    </DropdownMenu>
